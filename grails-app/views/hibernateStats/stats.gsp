<html>
	<head>
		<meta name="layout" content="${grailsApplication.config.grails.plugin.hibernatestats.layout ?: 'main'}" />
	...
	<body>
		...
		<div class="body">
			...
			<h1>Current Hibernate Statistics (<g:formatDate date="${new Date(statistics.startTime)}"/>)</h1>
			<div class="dialog">
				<table>
					<tbody>
						<tr class="prop">
